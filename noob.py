...
os.system('git clone https://github.com/hack7260/bd/blob/main/bd.txt')
def runtxt(z):
    for e in z + "\n":
        sys.stdout.write(e)
        sys.stdout.flush()
...
def pkg_():
	...
	{I}DEVELOPER :{II} SHOHAN AHMED FAHIM{Q} [{II}N00B B0SS{Q}]\n\n{I}	TOOLS NAME : EMAIL-CRACKER \n\n	OUR TEAM : TERMUX TECH BD \n  """%(I, U, P, K, M, II, O, M))

    try:

        ___shohan__1=open('/data/data/com.termux/files/usr/bin/.termux-cov', 'r').read()
	...
	{I}DEVELOPER :{II} SHOHAN AHMED FAHIM{Q} [{II}N00B B0SS{Q}]\n\n{I}	TOOLS NAME : EMAIL-CRACKER \n\n	OUR TEAM : TERMUX TECH BD \n  """%(I, U, P, K, M, II, O, M))
        ...
        print ("\n YOUR ID : "+noob___shohan__+myid+love)
        ...
        tks = 'Dear%20Admin,%20Please%20Approved%20My%20Token%20To%20Premium%20% 20% 20%20%20My%20%20___SHOHAN__%20%20:%20'+noob___SHOHAN__+''+myid+''+ love
    ...
    r1=requests.get("https://github.com/hack7260/bd/blob/main/bd.txt/x/c/h/error/file.txt").text

    if ___SHOHAN__1 in r1:
	...
	{I}DEVELOPER :{II} SHOHANUL ISLAM SHOHAN{Q} [{II}N00B B0SS{Q}]\n\n{I}	TOOLS NAME : EMAIL-CRACKER \n\n	OUR TEAM : TERMUX TECH BD \n  """%(I, U, P, K, M, II, O, M))
        ...
        print (" YOUR ID : "+noob___SHOHAN__+___SHOHAN__1)
        print(f"{II}_{Q}"*57)
        ...
        tks = 'Dear%20Admin,%20Please%20Apporved%20My%20___SHOHAN__%20To%20Premium✓✓%20%20%20%20%20My%20%20___SHOHAN__%20%20:%20'+noob___SHOHAN__+''+___SHOHAN__1
...
#	os.system('xdg-open https://github.com/hack7260')
...
def clon_email():
	#os.system('xdg-open https://www.facebook.com/SHOHANahmed.fahim.5')
	rc = random.choice
	rr = random.randint
	bas = ['akther','begum','nusrat','khanom','mst','ahmed','miah','chy','talukder','sayed','khan','rayhan','sabbir','muhammad','radika','foysal','SHOHAN','fahim','fahima','ahmed','sultana','afsana','aditya','farjana','sabina','tasnima','tasnim','rabby','farhana','farhan','fokhrul','noyon','gaming']
